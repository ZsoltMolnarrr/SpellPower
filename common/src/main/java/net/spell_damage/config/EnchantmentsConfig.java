package net.spell_damage.config;

import net.spell_damage.api.enchantment.Enchantments_SpellDamage;
import net.spell_damage.api.enchantment.ItemType;
import net.tinyconfig.models.EnchantmentConfig;
import org.jetbrains.annotations.Nullable;

import static net.spell_damage.api.enchantment.ItemType.MAGICAL_ARMOR;
import static net.spell_damage.api.enchantment.ItemType.MAGICAL_WEAPON;
