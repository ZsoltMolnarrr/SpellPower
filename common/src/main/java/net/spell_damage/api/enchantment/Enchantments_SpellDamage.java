...
import net.spell_damage.internals.AmplifierEnchantment;
import net.spell_damage.internals.Attributes;
import net.spell_damage.internals.SchoolFilteredEnchantment;
...
import static net.spell_damage.api.MagicSchool.*;
import static net.spell_damage.internals.AmplifierEnchantment.Operation.ADD;
import static net.spell_damage.internals.AmplifierEnchantment.Operation.MULTIPLY;
...
public class Enchantments_SpellDamage {
    ...
    public static final Identifier spellPowerId = new Identifier(SpellDamageMod.ID, spellPowerName);
    ...
    public static final Identifier soulfrostId = new Identifier(SpellDamageMod.ID, soulfrostName);
    ...
    public static final Identifier sunfireId = new Identifier(SpellDamageMod.ID, sunfireName);
    ...
    public static final Identifier energizeId = new Identifier(SpellDamageMod.ID, energizeName);
    ...
    public static final Identifier criticalChanceId = new Identifier(SpellDamageMod.ID, Attributes.CRITICAL_CHANCE);
    ...
    public static final Identifier criticalDamageId = new Identifier(SpellDamageMod.ID, Attributes.CRITICAL_DAMAGE);
    ...
    public static final Identifier hasteId = new Identifier(SpellDamageMod.ID, Attributes.HASTE);
